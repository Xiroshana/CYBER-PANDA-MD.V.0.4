...
//
global.Owner = ["+94764338173"];         //If you want singal number so global.Owner = ['916297175943'] Change into your number.
global.OwnerNumber = ["+94764338173"];   //If you want singal number so global.Owner = ['916297175943'] Change into your number.
global.ownertag = ["+94764338173"];
global.OwnerName = "IP BRO";
global.BotName = "පැන්ඩා බේබි 🥳";
global.packname = "🦋 DARK SHAN 🦋";                             //Do not change.
global.author = "lp bro";                               //Do not change.
...
//
global.location = "middeniya, Sri Lankan";
global.reactmoji = "💞";
global.themeemoji = "😂";
